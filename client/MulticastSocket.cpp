...
BOOL CMulticastSocket::CreateReceivingSocket(const char* strGroupIP, UINT nGroupPort)
{
...
void CMulticastSocket::OnReceive(int nErrorCode)
{
	...
	{
		//AfxMessageBox("Error receiving data from the host group"); // Ca me fait une erreur
	}
	else
	{
...
BOOL CMulticastSocket::JoinGroup(const char* GroupIP, UINT nGroupPort, UINT nTTL, BOOL bLoopback)
{
